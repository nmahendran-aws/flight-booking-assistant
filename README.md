...
1.  **MCP Server (`src/server.py`)**:
    -   Exposes `search_flights` tool via **FastMCP**.
...
### v0.3.0 - Enhanced Flight Search (Current)
...
-   **Updated Verification**: New test script `tests/verify_advanced.py` for complex queries.
